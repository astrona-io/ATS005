# User {{title}} Group Account Management — Playground

- **ID:** PLAYGROUND
- **Slug:** user-group-mgmt-playground
...
`astrona destroy` takes the environment name (`metadata.name` = `user-group-mgmt-playground`), not
