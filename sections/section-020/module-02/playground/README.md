# PAM Resource Limits {{title}} Concurrent Logins — Playground

- **ID:** PLAYGROUND
- **Slug:** pam-limits-playground
...
`astrona destroy` takes the environment name (`metadata.name` = `pam-limits-playground`), not
