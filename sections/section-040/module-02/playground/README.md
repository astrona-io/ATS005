# LDAP Directory Population {{title}} TLS Bind Verification — Playground

- **ID:** PLAYGROUND
- **Slug:** ldap-populate-playground
...
`astrona destroy` takes the environment name (`metadata.name` = `ldap-populate-playground`), not
